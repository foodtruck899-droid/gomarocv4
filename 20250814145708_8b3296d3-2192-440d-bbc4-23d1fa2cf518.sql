...
('customer_testimonials', 'testimonial_3', '{"name": "Marie Dubois", "location": "Lyon, France", "rating": 4, "comment": "Super expérience ! Bus moderne et propre, chauffeur très sympa. Un peu long mais cela est normal pour la distance.", "avatar_url": "/placeholder.svg"}', 'testimonial'),
('customer_testimonials', 'testimonial_4', '{"name": "Youssef El Amrani", "location": "Marrakech, Maroc", "rating": 5, "comment": "Service impeccable ! Je peux voyager en toute sérénité. Les prix sont très compétitifs par rapport à la concurrence.", "avatar_url": "/placeholder.svg"}', 'testimonial'),
